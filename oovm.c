...
static void interp(ovm_thread_t th, ovm_method_t m, bool tracef)
{
	...
	case 0x04:		/* stack_clear */
        ...
        case 0x22:		/* except_reraise */
	    interp_trace(th);
            ovm_except_reraise(th);
            break;

        case 0x23:		/* except_pop */
	    interp_trace(th);
            ovm_frame_except_pop(th, 1);
            break;

        case 0x24:		/* except_popn */
	    {
